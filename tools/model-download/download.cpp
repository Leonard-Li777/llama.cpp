...
static int common_download_file_single_online(const std::string & url,
    ...
    } else if (url.find("modelscope.cn") != std::string::npos) {
        // ModelScope HEAD requests are directly handled by modelscope.cn without redirecting
        // to CDN and do not contain Accept-Ranges or Content-Length headers, but the actual
        // GET request redirecting to Aliyun OSS does support Range.
